...
function validateCred(arrayOfCards){
	let validChecker = []
	let totalNum = 0;
	for(let i = 0; i < arrayOfCards.length; i++){
		if(i % 2 == 0){
			validChecker.push(arrayOfCards[i])
		}
		else if(i % 2 != 0){
			validChecker.push(arrayOfCards[i] * 2)
		}
	}
	for(let j = 0; j < validChecker.length; j++){
		totalNum += validChecker[j]
	}
	console.log('finsihed everything', validChecker)
	console.log('this is for total num', totalNum)
	console.log(totalNum % 2 ==  0 )
	return totalNum % 2 ==  0 
}
